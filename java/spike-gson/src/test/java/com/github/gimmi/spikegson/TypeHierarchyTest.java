...
public class TypeHierarchyTest {
	public static abstract class BaseClass {
		private String baseField = "base field value";
	...
	@Test
	public void should_just_consider_BaseClass_fields_without_typeadapter() {

		String json = new Gson().toJson(class1Instance, BaseClass.class).replace('"', '\'');

		assertEquals("{'baseField':'base field value','collection':[{'baseField':'base field value','collection':[]}]}", json);
	}
