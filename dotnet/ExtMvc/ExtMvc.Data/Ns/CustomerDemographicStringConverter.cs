...
{
	public class CustomerDemographicStringConverter : Nexida.Infrastructure.IStringConverter<ExtMvc.Domain.Ns.CustomerDemographic>
	{
		const char KeySeparator = '\\';
		private readonly ExtMvc.Data.Ns.CustomerDemographicRepository _repository;

		public CustomerDemographicStringConverter(ExtMvc.Data.Ns.CustomerDemographicRepository repository)
		{
			_repository = repository;
		}

		public string ToString(ExtMvc.Domain.Ns.CustomerDemographic obj)
		{
			return obj.CustomerTypeId.ToString();
		}

		public ExtMvc.Domain.Ns.CustomerDemographic FromString(string str)
		{
