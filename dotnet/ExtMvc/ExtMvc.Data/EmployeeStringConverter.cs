...
{
	public class EmployeeStringConverter : Nexida.Infrastructure.IStringConverter<ExtMvc.Domain.Employee>
	{
		const char KeySeparator = '\\';
		private readonly ExtMvc.Data.EmployeeRepository _repository;

		public EmployeeStringConverter(ExtMvc.Data.EmployeeRepository repository)
		{
			_repository = repository;
		}

		public string ToString(ExtMvc.Domain.Employee obj)
		{
			return obj.EmployeeId.ToString();
		}

		public ExtMvc.Domain.Employee FromString(string str)
		{
