namespace ExtMvc.Domain
{
	...
	public class Order 
	{
				...
				private ExtMvc.Domain.Customer _customer;
				
				private ExtMvc.Domain.Employee _employee;
		...
		set
				...
				public virtual ExtMvc.Domain.Customer Customer
				{ 
					get
					{
						return _customer;
		...
		set
				...
				public virtual ExtMvc.Domain.Employee Employee
				{ 
					get
					{
						return _employee;
