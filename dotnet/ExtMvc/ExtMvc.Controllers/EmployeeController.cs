...
namespace ExtMvc.Controllers
{
	public class EmployeeController : Controller
	{
		...
		public ActionResult Save(EmployeeDto item)
		{
		...
		public ActionResult ComboSearch()
		{
			...
			using(_conversation.SetAsCurrent())
			{
				IEnumerable<Employee> items = _repository.SearchNormal().AsEnumerable();
				EmployeeReferenceDto[] dtos = _mapper.Map<IEnumerable<Employee>, EmployeeReferenceDto[]>(items);
