	...
	public static class MappingEngineBuilder
	{
		...
		private static void DomainToDto()
		{
			...
			Mapper.CreateMap<Address, AddressDto>()
				.ForMember(d => d.StringId, o => o.MapFrom(s => sl.GetInstance<IStringConverter<Address>>().ToString(s)));
			Mapper.CreateMap<Address, AddressReferenceDto>()
				.ForMember(d => d.StringId, o => o.MapFrom(s => sl.GetInstance<IStringConverter<Address>>().ToString(s)))
				.ForMember(d => d.Description, o => o.MapFrom(s => s.ToString()));
		}
		...
		private static void DtoToDomain()
		{
			...
			Mapper.CreateMap<CategoryDto, Category>()
				.ConstructUsing(s => string.IsNullOrEmpty(s.StringId) ? sl.GetInstance<IFactory<Category>>().Create() : sl.GetInstance<IStringConverter<Category>>().FromString(s.StringId))
			...
			Mapper.CreateMap<CustomerDemographicDto, CustomerDemographic>()
				.ConstructUsing(s => string.IsNullOrEmpty(s.StringId) ? sl.GetInstance<IFactory<CustomerDemographic>>().Create() : sl.GetInstance<IStringConverter<CustomerDemographic>>().FromString(s.StringId))
			...
			Mapper.CreateMap<CustomerDto, Customer>()
				.ConstructUsing(s => string.IsNullOrEmpty(s.StringId) ? sl.GetInstance<IFactory<Customer>>().Create() : sl.GetInstance<IStringConverter<Customer>>().FromString(s.StringId))
				.ForMember(d => d.Customerdemographics, o => o.Ignore())
				.AfterMap(delegate(CustomerDto s, Customer d)
				{
					foreach(CustomerDemographic item in d.Customerdemographics.ToArray())
					{
						CustomerCustomerDemoAssociationSynchronizer.Disassociate(d, item);
					}
					CustomerDemographic[] items = Mapper.Map<CustomerDemographicDto[], CustomerDemographic[]>(s.Customerdemographics);
					foreach(CustomerDemographic item in items)
					{
						CustomerCustomerDemoAssociationSynchronizer.Associate(d, item);
					}
				})
			...
			Mapper.CreateMap<EmployeeDto, Employee>()
				.ConstructUsing(s => string.IsNullOrEmpty(s.StringId) ? sl.GetInstance<IFactory<Employee>>().Create() : sl.GetInstance<IStringConverter<Employee>>().FromString(s.StringId))
			...
			Mapper.CreateMap<OrderDetailDto, OrderDetail>()
				.ConstructUsing(s => string.IsNullOrEmpty(s.StringId) ? sl.GetInstance<IFactory<OrderDetail>>().Create() : sl.GetInstance<IStringConverter<OrderDetail>>().FromString(s.StringId))
				;
			...
			Mapper.CreateMap<OrderDto, Order>()
				.ConstructUsing(s => string.IsNullOrEmpty(s.StringId) ? sl.GetInstance<IFactory<Order>>().Create() : sl.GetInstance<IStringConverter<Order>>().FromString(s.StringId))
				.ForMember(d => d.Customer, o => o.Ignore())
				.AfterMap((s, d) => FkOrdersCustomersAssociationSynchronizer.Associate(d, Mapper.Map<CustomerReferenceDto, Customer>(s.Customer))
				).ForMember(d => d.Employee, o => o.Ignore())
				.AfterMap((s, d) => FkOrdersEmployeesAssociationSynchronizer.Associate(d, Mapper.Map<EmployeeReferenceDto, Employee>(s.Employee))
			...
			Mapper.CreateMap<ProductDto, Product>()
				.ConstructUsing(s => string.IsNullOrEmpty(s.StringId) ? sl.GetInstance<IFactory<Product>>().Create() : sl.GetInstance<IStringConverter<Product>>().FromString(s.StringId))
				.ForMember(d => d.Category, o => o.Ignore())
				.AfterMap((s, d) => FkProductsCategoriesAssociationSynchronizer.Associate(d, Mapper.Map<CategoryReferenceDto, Category>(s.Category))
			...
			Mapper.CreateMap<RegionDto, Region>()
				.ConstructUsing(s => string.IsNullOrEmpty(s.StringId) ? sl.GetInstance<IFactory<Region>>().Create() : sl.GetInstance<IStringConverter<Region>>().FromString(s.StringId))
				.ForMember(d => d.Territories, o => o.Ignore())
				;
			...
			Mapper.CreateMap<ShipperDto, Shipper>()
				.ConstructUsing(s => string.IsNullOrEmpty(s.StringId) ? sl.GetInstance<IFactory<Shipper>>().Create() : sl.GetInstance<IStringConverter<Shipper>>().FromString(s.StringId))
				.ForMember(d => d.Orders, o => o.Ignore())
				;
			...
			Mapper.CreateMap<SupplierDto, Supplier>()
				.ConstructUsing(s => string.IsNullOrEmpty(s.StringId) ? sl.GetInstance<IFactory<Supplier>>().Create() : sl.GetInstance<IStringConverter<Supplier>>().FromString(s.StringId))
				.ForMember(d => d.Products, o => o.Ignore())
				;
			...
			Mapper.CreateMap<TerritoryDto, Territory>()
				.ConstructUsing(s => string.IsNullOrEmpty(s.StringId) ? sl.GetInstance<IFactory<Territory>>().Create() : sl.GetInstance<IStringConverter<Territory>>().FromString(s.StringId))
				.ForMember(d => d.Employees, o => o.Ignore())
				.ForMember(d => d.Region, o => o.Ignore())
				.AfterMap((s, d) => FkTerritoriesRegionAssociationSynchronizer.Associate(d, Mapper.Map<RegionReferenceDto, Region>(s.Region))
				);
			...
			Mapper.CreateMap<AddressDto, Address>()
				.ConstructUsing(s => string.IsNullOrEmpty(s.StringId) ? sl.GetInstance<IFactory<Address>>().Create() : sl.GetInstance<IStringConverter<Address>>().FromString(s.StringId))
				;
			Mapper.CreateMap<AddressReferenceDto, Address>()
				.ConstructUsing(s => string.IsNullOrEmpty(s.StringId) ? sl.GetInstance<IFactory<Address>>().Create() : sl.GetInstance<IStringConverter<Address>>().FromString(s.StringId))
				.ForAllMembers(o => o.Ignore());
		}
	}
