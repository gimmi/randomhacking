...
ExtMvc.CategoryNormalSearchPanel = Ext.extend(Ext.Panel, {
	initComponent: function () {
		...
		_searchFormPanel = new ExtMvc.CategoryNormalSearchFormPanel({
		...
		_gridPanel = new ExtMvc.CategoryGridPanel({
			region: 'center',
			store: _store,
			bbar: _pagingToolbar,
			listeners: {
		...
		ExtMvc.CategoryNormalSearchPanel.superclass.initComponent.apply(_this, arguments);
