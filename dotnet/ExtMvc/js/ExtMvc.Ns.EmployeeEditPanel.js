...
ExtMvc.Ns.EmployeeEditPanel = Ext.extend(Ext.Panel, {
	initComponent: function () {
		var _this = this,
		_formPanel = new ExtMvc.Ns.EmployeeFormPanel(),
		...
		ExtMvc.Ns.EmployeeEditPanel.superclass.initComponent.apply(_this, arguments);
	}
});