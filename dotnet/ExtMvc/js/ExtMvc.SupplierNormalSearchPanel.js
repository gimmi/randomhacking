...
ExtMvc.SupplierNormalSearchPanel = Ext.extend(Ext.Panel, {
	initComponent: function () {
		...
		_searchFormPanel = new ExtMvc.SupplierNormalSearchFormPanel({
		...
		_gridPanel = new ExtMvc.SupplierGridPanel({
			region: 'center',
			store: _store,
			bbar: _pagingToolbar,
			listeners: {
		...
		ExtMvc.SupplierNormalSearchPanel.superclass.initComponent.apply(_this, arguments);
