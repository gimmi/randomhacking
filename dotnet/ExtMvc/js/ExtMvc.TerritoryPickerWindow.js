...
ExtMvc.TerritoryPickerWindow = Ext.extend(Ext.Window, {
	initComponent: function () {
		...
		_searchFormPanel = new ExtMvc.TerritoryNormalSearchFormPanel({
		...
		_gridPanel = new ExtMvc.TerritoryGridPanel({
			region: 'center',
			store: _store,
			bbar: _pagingToolbar,
			listeners: {
		...
		ExtMvc.TerritoryPickerWindow.superclass.initComponent.apply(_this, arguments);
