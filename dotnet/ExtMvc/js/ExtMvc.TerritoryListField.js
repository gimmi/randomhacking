...
ExtMvc.TerritoryListField = Ext.extend(Ext.form.Field, {
	initComponent: function () {
		...
		_gridPanel = new ExtMvc.TerritoryGridPanel(_cfg);
		...
		Ext.apply(_this, {
			onRender: function (ct, position) {
				...
				ExtMvc.TerritoryListField.superclass.onRender.call(_this, ct, position);
			...
			onResize: function (w, h, aw, ah) {
				ExtMvc.TerritoryListField.superclass.onResize.apply(_this, arguments);
				_gridPanel.setSize(w, h);
			},
			onEnable: function () {
				ExtMvc.TerritoryListField.superclass.onEnable.apply(_this, arguments);
				_gridPanel.enable();
			},
			onDisable: function () {
				ExtMvc.TerritoryListField.superclass.onDisable.apply(_this, arguments);
				_gridPanel.disable();
			},
			beforeDestroy: function () {
				Ext.destroy(_gridPanel);
				ExtMvc.TerritoryListField.superclass.beforeDestroy.apply(_this, arguments);
			},
			setValue: function (v) {
				_gridPanel.getStore().proxy.data.items = v;
				_gridPanel.getStore().load();
				return ExtMvc.TerritoryListField.superclass.setValue.apply(_this, arguments);
			},
			getValue: function () {
		...
		ExtMvc.TerritoryListField.superclass.initComponent.apply(_this, arguments);
	}
});

Ext.reg('ExtMvc.TerritoryListField', ExtMvc.TerritoryListField);