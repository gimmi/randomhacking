...
ExtMvc.CustomerEditPanel = Ext.extend(Ext.Panel, {
	initComponent: function () {
		var _this = this,
		_formPanel = new ExtMvc.CustomerFormPanel(),
		...
		ExtMvc.CustomerEditPanel.superclass.initComponent.apply(_this, arguments);
	}
});