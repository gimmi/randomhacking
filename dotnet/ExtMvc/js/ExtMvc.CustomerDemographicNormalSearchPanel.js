...
ExtMvc.CustomerDemographicNormalSearchPanel = Ext.extend(Ext.Panel, {
	initComponent: function () {
		...
		_searchFormPanel = new ExtMvc.CustomerDemographicNormalSearchFormPanel({
		...
		_gridPanel = new ExtMvc.CustomerDemographicGridPanel({
			region: 'center',
			store: _store,
			bbar: _pagingToolbar,
			listeners: {
		...
		_onDeleteButtonClick = function () {
			...
			Ext.MessageBox.confirm('Delete', 'Are you sure?', function (buttonId) {
				...
				Rpc.call({
					url: '/CustomerDemographic/Delete',
		...
		ExtMvc.CustomerDemographicNormalSearchPanel.superclass.initComponent.apply(_this, arguments);
