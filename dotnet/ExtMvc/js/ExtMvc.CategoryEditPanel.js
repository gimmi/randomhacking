...
ExtMvc.CategoryEditPanel = Ext.extend(Ext.Panel, {
	initComponent: function () {
		var _this = this,
		_formPanel = new ExtMvc.CategoryFormPanel(),
		...
		ExtMvc.CategoryEditPanel.superclass.initComponent.apply(_this, arguments);
	}
});