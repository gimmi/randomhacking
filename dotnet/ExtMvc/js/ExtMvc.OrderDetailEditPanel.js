...
ExtMvc.OrderDetailEditPanel = Ext.extend(Ext.Panel, {
	initComponent: function () {
		var _this = this,
		_formPanel = new ExtMvc.OrderDetailFormPanel(),
		...
		ExtMvc.OrderDetailEditPanel.superclass.initComponent.apply(_this, arguments);
	}
});