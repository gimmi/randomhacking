...
ExtMvc.OrderDetailPickerWindow = Ext.extend(Ext.Window, {
	initComponent: function () {
		...
		_searchFormPanel = new ExtMvc.OrderDetailSearchFormPanel({
		...
		_gridPanel = new ExtMvc.OrderDetailGridPanel({
			region: 'center',
			store: _store,
			bbar: _pagingToolbar,
			listeners: {
		...
		ExtMvc.OrderDetailPickerWindow.superclass.initComponent.apply(_this, arguments);
