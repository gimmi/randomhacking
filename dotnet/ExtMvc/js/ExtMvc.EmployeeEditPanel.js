...
ExtMvc.EmployeeEditPanel = Ext.extend(Ext.Panel, {
	initComponent: function () {
		var _this = this,
		_formPanel = new ExtMvc.EmployeeFormPanel(),
		...
		ExtMvc.EmployeeEditPanel.superclass.initComponent.apply(_this, arguments);
	}
});