...
ExtMvc.Ns.CategoryEditPanel = Ext.extend(Ext.Panel, {
	initComponent: function () {
		var _this = this,
		_formPanel = new ExtMvc.Ns.CategoryFormPanel(),
		...
		ExtMvc.Ns.CategoryEditPanel.superclass.initComponent.apply(_this, arguments);
	}
});