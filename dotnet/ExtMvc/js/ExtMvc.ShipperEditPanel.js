...
ExtMvc.ShipperEditPanel = Ext.extend(Ext.Panel, {
	initComponent: function () {
		var _this = this,
		_formPanel = new ExtMvc.ShipperFormPanel(),
		...
		ExtMvc.ShipperEditPanel.superclass.initComponent.apply(_this, arguments);
	}
});