...
ExtMvc.SupplierEditPanel = Ext.extend(Ext.Panel, {
	initComponent: function () {
		var _this = this,
		_formPanel = new ExtMvc.SupplierFormPanel(),
		...
		ExtMvc.SupplierEditPanel.superclass.initComponent.apply(_this, arguments);
	}
});