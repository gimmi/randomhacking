...
ExtMvc.TerritoryEditPanel = Ext.extend(Ext.Panel, {
	initComponent: function () {
		var _this = this,
		_formPanel = new ExtMvc.TerritoryFormPanel(),
		...
		ExtMvc.TerritoryEditPanel.superclass.initComponent.apply(_this, arguments);
	}
});