...
ExtMvc.Ns.CustomerEditPanel = Ext.extend(Ext.Panel, {
	initComponent: function () {
		var _this = this,
		_formPanel = new ExtMvc.Ns.CustomerFormPanel(),
		...
		ExtMvc.Ns.CustomerEditPanel.superclass.initComponent.apply(_this, arguments);
	}
});