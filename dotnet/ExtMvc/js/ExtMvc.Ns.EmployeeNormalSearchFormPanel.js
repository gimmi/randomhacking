...
ExtMvc.Ns.EmployeeNormalSearchFormPanel = Ext.extend(Ext.form.FormPanel, {
	labelWidth: 100,
	border: false,
	padding: 10,
	initComponent: function () {
		...
		ExtMvc.Ns.EmployeeNormalSearchFormPanel.superclass.initComponent.apply(this, arguments);
	}
});