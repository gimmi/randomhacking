...
ExtMvc.Ns.EmployeeField = Ext.extend(Ext.ux.ProxyField, {
	initComponent: function () {
		...
		_valueProxy = new Rpc.LoadableValue({
			...
			setValue: function (v) {
				...
				ExtMvc.Ns.EmployeeField.superclass.setValue.apply(_this, arguments);
			}
		}),
		_store = new Ext.data.Store({
			autoDestroy: true,
			proxy: new Rpc.JsonPostHttpProxy({
				url: 'NsEmployee/ComboSearch'
			}),
		...
		ExtMvc.Ns.EmployeeField.superclass.initComponent.apply(_this, arguments);
...
Ext.reg('ExtMvc.Ns.EmployeeField', ExtMvc.Ns.EmployeeField);